...
module "eks" {
  ...
  cluster_endpoint_public_access_cidrs = [ "54.205.46.139/32" ]
...
#      description                = "Vesttoo VPN inbound"
#      protocol                   = "tcp"
#      from_port                  = 443
#      to_port                    = 443
#      type                       = "ingress"
...
#  cluster_security_group_tags = local.tags
  ...
  eks_managed_node_groups = {
    initial = {
      instance_types  = ["m6i.large", "m5n.large"]
      capacity_type   = "SPOT"
      min_size        = 1
      max_size        = 1
      desired_size    = 1
